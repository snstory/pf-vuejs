...
import FindAlert from 'src/stepCE/FindAlert.vue'
import IconLayer from 'src/stepCE/IconLayer.vue'
import TitleLayer from 'src/stepCE/TitleLayer.vue'
import PuzzleButton from 'src/stepCE/PuzzleButton.vue'
import AllSSound from 'src/stepCE/AllSSound.vue'
